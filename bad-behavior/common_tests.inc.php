 ...
 * @return false|string
 */
function bb2_protocol( array $settings, array $package ): bool|string { // phpcs:ignore Generic.PHP.Syntax.PHPSyntax
 ...
 * @return false|string
 */
function bb2_cookies( array $package ): bool|string {
 ...
 * @return false|string
 */
function bb2_misc_headers( array $settings, array $package ): bool|string {
