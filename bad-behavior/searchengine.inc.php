 ...
 * @return false|int
 */
function bb2_google( array $package ): bool|int {
 ...
 * @return false|int
 */
function bb2_msnbot( array $package ): bool|int {
	if ( is_ipv6( $package['ip'] ) ) {
		return false;
	}    // TODO
	if ( match_cidr(
 ...
 * @return false|int
 */
function bb2_yahoo( array $package ): bool|int {
	if ( is_ipv6( $package['ip'] ) ) {
		return false;
	}    // TODO
	if ( match_cidr(
 ...
 * @return false|int
 */
function bb2_baidu( array $package ): bool|int {
	if ( is_ipv6( $package['ip'] ) ) {
		return false;
	}    // TODO
